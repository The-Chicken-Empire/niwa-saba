...
execute as @a if score @s food matches 19.. run effect give @s hunger 1 255 true
execute as @a if score @s food matches ..18 run effect clear @s hunger
execute as @a if score @s food matches 17 run effect give @s saturation 1 255 true
